...
RAW_PATH   = os.path.join(os.path.dirname(os.path.abspath(__file__)), "final_balanced_fake_job_postings.csv")
CLEAN_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cleaned_jobs.csv")
