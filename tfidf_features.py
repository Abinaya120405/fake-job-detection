...
CLEAN_DATA_PATH    = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cleaned_jobs.csv")
...
META_FEATURES_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "meta_features.npy")
